...
public class AddFaculty extends JFrame implements ActionListener{
    ...
    JTextField tfname, tffname, tfaddress, tfphone, tfemail, tfx, tfxii, tfaadhar, empId;
    JDateChooser dcdob;
    ...
    AddFaculty() {
        ...
        lblfname.setBounds(470, 150, 200, 30);
        ...
        lbldob.setBounds(470, 200, 200, 30);
        ...
        lblaadhar.setBounds(470, 350, 200, 30);
        ...
        lblbranch.setBounds(470, 400, 200, 30);
        lblbranch.setFont(new Font("serif", Font.BOLD, 20));
        add(lblbranch);

        String department[] = {"CSE", "ECE", "IT", "Civil", "AIDS", "AIML", "EEE", "Mech", "Cybersecurity"};
        ...
        submit.setBounds(280, 510, 120, 30);
        ...
        cancel.setBounds(470, 510, 120, 30);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            String EmployeID = empId.getText();
            ...
            try {
                String query = "insert into faculty values('"+name+"', '"+fname+"', '"+EmployeID+"', '"+dob+"', '"+address+"', '"+phone+"', '"+email+"', '"+x+"', '"+xii+"', '"+aadhar+"', '"+course+"', '"+department+"')";
